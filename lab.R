...
#' A: Some rural counties may not be able to test and provide accurate results, could introduce noises.
#' 
#' 

#' 2. *How about the Google Mobility data?* 
#' A: Unable to track people without smartphone or people who do not turn on location history.
#' 
...
#' A: From 2020-01-21 to 2020-09-27
#'  
#' 

#' 2. *What is the `fips` variable?* 
#' A: FIPS codes, a standard geographic identifier
#' 
#' 
...
#' A: Some of them might be "probable" cases and deaths, according to the provenance 
#' 
#' 
...
#' A: Based on the provenance, this can occur when a county corrects an error in the number of cases they’ve reported in the past, or when a state moves cases from one county to another.
#' 
#' 
...
#' A: Seems about right for certain counties, but there are also counties experiencing continuing outbreak in September
#' 
#' 
...
#' A: 6, different categories of place where movement trends are gathered
#' 
#' 
...
#' A: Merced folks definitely went out more during summer, damn
#' 
#' 

#' 6. *What other potentially interesting patterns do you see in these mobility data?* 
#' A: Merced folks love going to parks, damn
#' 
...
#' A: We can also look at other types of mobility in June and how they relate to cases and deaths in July
#' 
#' 
